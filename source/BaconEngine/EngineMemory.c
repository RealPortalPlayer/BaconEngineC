...
SEC_CPP_GUARD_START()
    ...
    size_t BE_EngineMemory_GetAllocatedBytes(void) {
        return memoryInformation.command.allocatedBytes + memoryInformation.ui.allocatedBytes + memoryInformation.dynamicArray.allocatedBytes + memoryInformation.layer.allocatedBytes;
    }

    BE_EngineMemory_MemoryTypeInformation* GetMemoryTypeInformation(BE_EngineMemory_MemoryType memoryType) {
        switch (memoryType) {
    ...
    void* BE_EngineMemory_AllocateMemory(size_t size, BE_EngineMemory_MemoryType memoryType) {
        void* pointer;
        BE_EngineMemory_MemoryTypeInformation* memoryTypeInformation = GetMemoryTypeInformation(memoryType);
