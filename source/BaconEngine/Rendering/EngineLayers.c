...
SEC_Boolean beEngineLayersMovingUi = SEC_BOOLEAN_FALSE;
...
void BE_EngineLayers_Initialize(void) {
    ...
    BE_Layer_Register("BE_UIRendering", SEC_BOOLEAN_TRUE, (BE_Layer_Functions) {
...
SEC_Boolean BE_EngineLayers_ConsoleOpener_OnEvent(BE_Event event) {
    ...
    BE_UI_ToggleWindowFlag(0, BE_UI_WINDOW_FLAG_CLOSED, SEC_BOOLEAN_FALSE);
    return SEC_BOOLEAN_TRUE;
}

#define TITLE_COLORS (uiWindow->currentRenderPosition == 0 ? SEC_CPLUSPLUS_SUPPORT_CREATE_STRUCT(BE_Color4_Unsigned, 60, 60, 60, 255) : SEC_CPLUSPLUS_SUPPORT_CREATE_STRUCT(BE_Color4_Unsigned, 44, 44, 44, 255))
#define WINDOW_COLORS (uiWindow->currentRenderPosition == 0 ? SEC_CPLUSPLUS_SUPPORT_CREATE_STRUCT(BE_Color4_Unsigned, 102, 102, 102, 255) : INACTIVE_WINDOW_COLORS)
#define CLOSE_BUTTON_COLORS (uiWindow->currentRenderPosition == 0 ? SEC_CPLUSPLUS_SUPPORT_CREATE_STRUCT(BE_Color4_Unsigned, 249, 112, 104, 255) : INACTIVE_CLOSE_BUTTON_COLORS)
#define MINIMIZE_BUTTON_COLORS (uiWindow->currentRenderPosition == 0 ? SEC_CPLUSPLUS_SUPPORT_CREATE_STRUCT(BE_Color4_Unsigned, 255, 200, 87, 255) : INACTIVE_MINIMIZE_BUTTON_COLORS)
#define MAXIMIZE_BUTTON_COLORS (uiWindow->currentRenderPosition == 0 ? SEC_CPLUSPLUS_SUPPORT_CREATE_STRUCT(BE_Color4_Unsigned, 78, 185, 99, 255) : SEC_CPLUSPLUS_SUPPORT_CREATE_STRUCT(BE_Color4_Unsigned, 78, 185, 99, 175))
#define INACTIVE_WINDOW_COLORS SEC_CPLUSPLUS_SUPPORT_CREATE_STRUCT(BE_Color4_Unsigned, 73, 73, 73, 255)
#define INACTIVE_CLOSE_BUTTON_COLORS SEC_CPLUSPLUS_SUPPORT_CREATE_STRUCT(BE_Color4_Unsigned, 249, 112, 104, 175)
#define INACTIVE_MINIMIZE_BUTTON_COLORS SEC_CPLUSPLUS_SUPPORT_CREATE_STRUCT(BE_Color4_Unsigned, 255, 200, 87, 175)
...
void BE_EngineLayers_RenderButtons(BE_PrivateUI_Window* uiWindow, BE_Vector2_Integer position) {
    ...
    if (!BE_BITWISE_IS_BIT_SET(uiWindow->flags, BE_UI_WINDOW_FLAG_NO_CLOSE) || !BE_BITWISE_IS_BIT_SET(uiWindow->flags, BE_UI_WINDOW_FLAG_NO_MINIMIZE) || !BE_BITWISE_IS_BIT_SET(uiWindow->flags, BE_UI_WINDOW_FLAG_NO_MAXIMIZE)) {
        if (!BE_BITWISE_IS_BIT_SET(uiWindow->flags, BE_UI_WINDOW_FLAG_NO_CLOSE))
            BE_RENDERER_DRAW_BORDERED_RECTANGLE_SAME_COLOR(updatedPosition, SEC_CPLUSPLUS_SUPPORT_CREATE_STRUCT(BE_Vector2_Unsigned, 10, 10), CLOSE_BUTTON_COLORS, 2);
        else
            BE_RENDERER_DRAW_BORDERED_RECTANGLE_SAME_COLOR(updatedPosition, SEC_CPLUSPLUS_SUPPORT_CREATE_STRUCT(BE_Vector2_Unsigned, 10, 10), uiWindow->currentRenderPosition == 0 ? WINDOW_COLORS : INACTIVE_WINDOW_COLORS, 2);
    ...
    if (!BE_BITWISE_IS_BIT_SET(uiWindow->flags, BE_UI_WINDOW_FLAG_NO_MINIMIZE) || !BE_BITWISE_IS_BIT_SET(uiWindow->flags, BE_UI_WINDOW_FLAG_NO_MAXIMIZE)) {
        if (!BE_BITWISE_IS_BIT_SET(uiWindow->flags, BE_UI_WINDOW_FLAG_NO_MINIMIZE))
            BE_RENDERER_DRAW_BORDERED_RECTANGLE_SAME_COLOR(updatedPosition, SEC_CPLUSPLUS_SUPPORT_CREATE_STRUCT(BE_Vector2_Unsigned, 10, 10), MINIMIZE_BUTTON_COLORS, 2);
        else
            BE_RENDERER_DRAW_BORDERED_RECTANGLE_SAME_COLOR(updatedPosition, SEC_CPLUSPLUS_SUPPORT_CREATE_STRUCT(BE_Vector2_Unsigned, 10, 10), uiWindow->currentRenderPosition == 0 ? WINDOW_COLORS : INACTIVE_WINDOW_COLORS, 2);
    ...
    BE_RENDERER_DRAW_BORDERED_RECTANGLE_SAME_COLOR(updatedPosition, SEC_CPLUSPLUS_SUPPORT_CREATE_STRUCT(BE_Vector2_Unsigned, 10, 10), MAXIMIZE_BUTTON_COLORS, 2);
}
...
void BE_EngineLayers_UIRendering_OnUpdate(BE_Layer_UpdateTypes updateType) {
    ...
    for (int windowId = uiWindows->used - 1; windowId >= 0; windowId--) {
        ...
        if (BE_BITWISE_IS_BIT_SET(uiWindow->flags, BE_UI_WINDOW_FLAG_MINIMIZED)) {
            BE_RENDERER_DRAW_BORDERED_RECTANGLE_SAME_COLOR(position, SEC_CPLUSPLUS_SUPPORT_CREATE_STRUCT(BE_Vector2_Unsigned, size.x, 20), TITLE_COLORS, 2);
            BE_EngineLayers_RenderButtons(uiWindow, position);
            continue;
        }

        BE_RENDERER_DRAW_BORDERED_RECTANGLE_SAME_COLOR(SEC_CPLUSPLUS_SUPPORT_CREATE_STRUCT(BE_Vector2_Integer, position.x, position.y + 23), size, WINDOW_COLORS, 2);
        BE_RENDERER_DRAW_BORDERED_RECTANGLE_SAME_COLOR(position, SEC_CPLUSPLUS_SUPPORT_CREATE_STRUCT(BE_Vector2_Unsigned, size.x, 20), TITLE_COLORS, 2);
        BE_EngineLayers_RenderButtons(uiWindow, position);
    }
}
