...
BE_BINARYEXPORT BA_Boolean BE_Window_IsVisible(void);
BE_BINARYEXPORT BA_Boolean BE_Window_IsStillOpened(void);
...
BE_BINARYEXPORT void BE_Window_SetVisibility(BA_Boolean visible);
