...
CPP_GUARD_START()
    typedef enum {
        ...
        UI_WINDOW_FLAG_CLOSED = (1 << 8),
        UI_WINDOW_FLAG_NO_TITLE_BAR = (1 << 10),
        UI_WINDOW_FLAG_NO_CLOSE = (1 << 12),
        UI_WINDOW_FLAG_NO_MINIMIZE = (1 << 14),
        UI_WINDOW_FLAG_NO_MAXIMIZE = (1 << 16),
        UI_WINDOW_FLAG_NO_BORDER = (1 << 18),
